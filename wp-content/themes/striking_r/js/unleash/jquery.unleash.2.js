...
/*$element.children().hide();
			$(window).load(function() {
             ...
             if ($opts.initially_open_slide != 0) {
                 ...
                 if ($opts.slideshow) {skip_open_slide_once=true;}
             }
         ...
         construct: function () {
             ...
             $elem.find($opts.captionClassName).each(function (i) {
                 ...
                 case "pop-up":
                     $(this).css("bottom", -$this.slide_height + "px");
                     break;
                 case "opacity":
                     $(this).css({
                         bottom: "0px",
