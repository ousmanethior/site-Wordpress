...
(function($,undefined){
	...
	$.fn.extend({
		...
		var defaults = {
			...
			googleFontJS:(document.location.protocol?"https:":"http:")+'//ajax.googleapis.com/ajax/libs/webfont/1/webfont.js',
			debug:"no",
			rescaleBGColor:"#333"
					...
					function prepareSlide(top,opt,nr) {
						...
						top.find('ul >li').each(function(i) {
							if (i==nr) {
										...
										$this.wrapInner('<div class="slide_container" style="z-index:10;position:absolute;top:0px;left:0px;width:'+opt.width+'px;height:'+opt.height+'px;overflow:hidden"><div class="parallax_container" style="position:absolute;top:0px;left:0px"><div class="kb_container" style="width:'+opt.width+'px"></div></div></div>');
