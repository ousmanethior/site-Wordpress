...
<body <?php body_class(); ?>>
<?php 	
	$reponsivemenu_shortcode_mode=theme_get_responsive_menu_shortcode_setting();
	if (theme_get_responsive_menu_header_location()!='manual' && $reponsivemenu_shortcode_mode) echo do_shortcode(theme_get_responsive_menu_shortcode());
?>
<div class="body-warp">
<header id="header">
	<div class="inner">
