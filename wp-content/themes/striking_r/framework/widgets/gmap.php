...
class Theme_Widget_Gmap extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if (isset($instance['blackwhite'])) $blackwhite = $instance['blackwhite']; else $blackwhite='';
		if ($blackwhite=='1') $blackwhite='true'; else $blackwhite='false';
...
SCRIPT;
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['blackwhite'] = !empty($new_instance['blackwhite']) ? 1 : 0;
	...
	function form( $instance ) {
		...
		$blackwhite = isset( $instance['blackwhite'] ) ? (bool) $instance['blackwhite'] : false;
...
?>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id('blackwhite'); ?>" name="<?php echo $this->get_field_name('blackwhite'); ?>"<?php checked( $blackwhite ); ?> />
		<label for="<?php echo $this->get_field_id('blackwhite'); ?>"><?php _e( 'Black and White map?', 'theme_admin' ); ?></label></p>
