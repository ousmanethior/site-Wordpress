...
<?php $list_image = get_post_meta(get_the_ID(), '_list_image', true);
...
<?php if (has_post_thumbnail() && empty($list_image)): ?>
...
<?php elseif (!empty($list_image)) :?>
				<a class="thumbnail" href="<?php echo get_permalink() ?>" title="<?php the_title();?>">
					<img src="<?php echo $list_image;?>" width="<?php echo $thumbnail_size;?>" height="<?php echo $thumbnail_size;?>" title="<?php the_title();?>" alt="<?php the_title();?>"/>
				</a>
