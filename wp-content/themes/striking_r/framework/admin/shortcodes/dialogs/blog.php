...
return array(
	...
	"options" => array(
		...
		array(
			"name" => __("Read More Text & Button Text Color (Optional)&#x200E;",'theme_admin'),
			"id" => "readMoreColor",
			"default" => '',
			"type" => "color"
		),
		array(
			"name" => __("Read More Text Hover & Button Text Hover Color (Optional)&#x200E;",'theme_admin'),
			"id" => "readMoreHoverColor",
			"default" => '',
			"type" => "color"
		),
		array(
			"name" => __("Read More Button Background Color (Optional)&#x200E;",'theme_admin'),
			"id" => "readMoreButtonColor",
			"default" => '',
			"type" => "color"
		),
		array(
			"name" => __("Read More Button Background Hover Color (Optional)&#x200E;",'theme_admin'),
			"id" => "readMoreButtonHoverColor",
			"default" => '',
			"type" => "color"
		),
		array(
		...
		array(
			...
			"desc" => __("If this option is ON, it will remove the shortcodes from the excerpt in the blog listing pages. This only works when Enable Shortcode for excerpt (see Theme Static Blog Page Settings) and Display Full Blog Posts are turned OFF. Note: Only applies to the real excerpt. Not the excerpt generated from the content when no excerpt has been added.",'theme_admin'),
