...
$init_script = <<<HTML
	...
	jQuery('select[name^="icon_"]').selecttwo({
		width: '70%',
		formatResult: format,
	...
	jQuery('[name="number"]').on("change",function(){
		...
		if(selectedOption>accordion_number || !selectedOption){
			if (selectedOption>accordion_number) selectedOption=accordion_number; else selectedOption = 1;
		}
