...
function theme_admin_register_script(){
	...
	wp_register_script('jquery-colorinput',THEME_ADMIN_ASSETS_URI . '/js/jquery.colorInput.min.js',array('jquery'));
	wp_register_script('jquery-selecttwo',THEME_ADMIN_ASSETS_URI . '/js/selecttwo.min.js',array('jquery'),'3.4.1');
	...
	wp_register_script('theme-base', THEME_ADMIN_ASSETS_URI . '/js/theme.js',array('jquery','jquery-outside-events','jquery-colorinput','jquery-switcher','jquery-choice','jquery-tools-validator','jquery-ui-slider','jquery-selecttwo','jquery-ui-sortable'));
...
function theme_fix_the_events_calendar_issue(){
	...
	if ( isset($current_screen->post_type) && $current_screen->post_type === 'tribe_events'){
		wp_dequeue_script('jquery-selecttwo');
	}
}