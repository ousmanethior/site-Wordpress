...
class Theme_Options_Page_Slideshow extends Theme_Options_Page_With_Sub_Tabs {
	...
	public static function kenOption($field){
		return array(
			...
			array(
				"name"=>__("Show Description After animation",'theme_admin'),
	...
	public static function unleashOption($field){
		return array(
			...
			array(
				"name"=>__("Caption Animation",'theme_admin'),
			...
			// ),
			array(
				"name"=>__("Enable Controls",'theme_admin'),
				"id" => "unleash_".$field."_controls",
				"default" => false,
				"type"=>"toggle",
			),
			array(
				"name"=>__("Hide Controls",'theme_admin'),
			...
			array(
				"name"=>__("Pauses On Mouse Over",'theme_admin'),
	...
	public static function roundaboutOption($field){
		return array(
			...
			array(
				"name"=>__("Caption Show On Hover",'theme_admin'),
			...
			array(
				"name"=>__("Caption Custom Style",'theme_admin'),
