...
//					),
			...
			array(
				"slug" => 'miscellaneous',
				"name" => __("Content & Shortcodes ",'theme_admin'),
				"options" => array(
					array(
					...
					array(
						"name" => __("Carousel Caption Text Color",'theme_admin'),
						"desc" => "",
						"id" => "carousel_caption_text",
						"default" => "#303030",
						"type" => "color"
					),
					array(
						"name" => __("Carousel Caption Background Color",'theme_admin'),
						"desc" => "",
						"id" => "carousel_caption_bg",
						"default" => "rgba( 200,200,160,0.8)",
						"type" => "color"
					),
					array(
					...
					array(
						"name" => __("Testimonials Border Color",'theme_admin'),
						"desc" => "",
						"id" => "testimonials_border_color",
						"default" => "#e5e5e5",
						"type" => "color"
					),
					array(
						"name" => __("Testimonials Content Background Color",'theme_admin'),
						"desc" => "",
						"id" => "testimonials_content_bgcolor",
						"default" => "#fafafa",
						"type" => "color"
					),
					array(
						"name" => __("Testimonials Content Text Color",'theme_admin'),
						"desc" => "",
						"id" => "testimonials_content_textcolor",
						"default" => "#777777",
						"type" => "color"
					),
					array(
						"name" => __("Testimonials Authorname Color",'theme_admin'),
						"desc" => "",
						"id" => "testimonials_authorname_color",
						"default" => "#333333",
						"type" => "color"
					),
					array(
						"name" => __("Testimonials Meta Color",'theme_admin'),
						"desc" => "",
						"id" => "testimonials_meta_color",
						"default" => "#777777",
						"type" => "color"
					),
					array(
						"name" => __("Testimonials Meta Link Hover Color",'theme_admin'),
						"desc" => "",
						"id" => "testimonials_meta_active_color",
						"default" => "rgba(60,139,206,1)",
						"type" => "color"
					),
					array(
						"name" => __("Testimonials Nav Icon Color",'theme_admin'),
						"desc" => "",
					...
					array(
						"name" => __("Testimonials Nav Hover Color",'theme_admin'),
						"desc" => "",
						"id" => "testimonials_nav_active_color",
						"default" => "#8d8d8d",
						"type" => "color"
					),
					array(
						"name" => __("Fancybox Overlay Background Color",'theme_admin'),
						"desc" => "",
						"id" => "fancybox_overlay_bg",
						"default" => "",
						"type" => "color"
					),
				),
			...
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("Blog Meta Icon Color",'theme_admin'),
						"desc" => "",
						"id" => "blog_meta_icon",
						"default" => "#666666",
						"type" => "color"
					...
					array(
						"name" => __("Blog Read More Text Color",'theme_admin'),
						"id" => "read_more_text_color",
						"default" => "#666666",
						"type" => "color"
					),
					array(
						"name" => __("Blog Read More Text Hover Color",'theme_admin'),
						"id" => "read_more_active_text_color",
						"default" => "",
						"type" => "color"
					),
					array(
						"name" => __("Excerpt Link Color",'theme_admin'),
						"desc" => "",
						"id" => "excerpt_link_color",
						"default" => "#666666",
						"type" => "color"
					),
					array(
						"name" => __("Excerpt Link Hover Color",'theme_admin'),
						"desc" => "",
						"id" => "excerpt_link_active",
						"default" => "",
						"type" => "color"
					),
					array(
			...
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("Accordion Icon Color",'theme_admin'),
						"desc" => "",
						"id" => "accordion_icon",
						"default" => "#444444",
						"type" => "color"
					...
					array(
						"name" => __("Accordion Current Icon Color",'theme_admin'),
						"desc" => "",
						"id" => "accordion_current_icon",
						"default" => "#444444",
						"type" => "color"
					),
				),
