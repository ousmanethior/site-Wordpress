			...
			array(
				...
				"options" => array(
					array(
						...
						"type" => "select",
						"process" => "_option_demotype_process"
					),
					array(
...
jQuery(document).ready(function($){
	$('#install_button').on('click',function() {
		...
		$.post(ajaxurl, {
			...
			loading.remove();
			$( "span" ).remove( ".theme-install-done" );
			$('<span class="theme-install-done">'+ response+'</span>').insertAfter(button);
		});
...
HTML;
	...
	function _option_demotype_process($option,$value) {
		return 'large';
	}
