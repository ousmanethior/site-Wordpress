...
class Theme_Options_Page_General extends Theme_Options_Page_With_Tabs {
	...
	function tabs(){
		...
		if (function_exists('check_responsive_menu_pro_php_version') || function_exists('check_responsive_menu_php_version')) {
			$responsive_menu_options=array("body" => __('Body Top','theme_admin'),"header" => __('Header','theme_admin'),"manual" => __('Manual','theme_admin'));
			
			$desc=__("Set the location for the Responsive Menu to appear into our page content. We move the containers according this setting. <br><br>There are 3 options: <br><br><strong>'Body'</strong> : The Responsive menu code is inserted in the top of the body before the Theme Header.<br><strong>'Header'</strong> : The Responsive menu code is inserted in the top of the header element. If not found it will revert to the top of the body element.<br><strong>'Manual'</strong> : We do  not move the Responsive Menu containers into the top of the body. They are left in the Footer (default Plugin). Default = 'Body'.<br><br>Note : The Responsive Menu Plugin also has a setting in the plugin Advanced Option Panel called 'Use Shortcode?'. If that Shortcode setting is turned to 'ON' and you have set this setting here to 'manual', you need to insert the Responsive Menu Button manually by inserting a Responsive Menu Shortcode in a page/post content or text widget.",'theme_admin');
			
			$array_navigation_additional_settings = array(
					array(
						"name" => __("Responsive Menu Location (mobile)",'theme_admin'),
						"desc" => $desc,
						"id" => "responsive_menu_header_location",
						"default" => 'body',
						"options" => $responsive_menu_options,
						"type" => "select",
					),
				);
			$array_navigation=array_merge($array_navigation,$array_navigation_additional_settings);
		}
		return array(
			array(
				"slug" => 'header',
				...
				"options" => array(
					...
					array (
						"name" => __("Responsive Header Height (Optional)&#x200E;",'theme_admin'),
						"desc" => __("<p>Set the Header Inner height in pixels for the mobile breakpoint between 768 and 979px. In some rare occasions it can happen that the Header height between 768px and 979px is not correct. In most cases this happens when too much content is added in the Top Area or the Select2 Mobile menu is hidden by css or a plugin. By this setting you adjust the height of the header for that viewpoint only. Default = 0. When set to 0 the default css is applied for that breakpoint and this setting is ignored.</p>",'theme_admin'),
