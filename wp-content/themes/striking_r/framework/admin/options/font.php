...
<p>In Striking MultiFlex, all the text types below have a corresponding theme color setting which can found in the <a href='%s' target='_blank'>Color Panel.</a> part of the array of over 145 theme color settings (all optional to adjust from their defaults) allowing for a unique font size and color palette for each website.",'theme_admin'),admin_url( 'admin.php?page=theme_color')),			
				"options" => array(
					...
					array(
						"name" => __("Pagination Text",'theme_admin'),
						"desc" => __("<p>Set the size for the Pagination Text.</p>",'theme_admin'),	
						"id" => "pagenavi",
						"min" => "1",
						"max" => "60",
						"step" => "1",
					...
					array(
						"name" => __("Pagination Text Current",'theme_admin'),
						"desc" => __("<p>Set the size for the Pagination Current Text.</p>",'theme_admin'),	
						"id" => "pagenavi_current",
						"min" => "1",
						"max" => "60",
						"step" => "1",
					...
					array(
						"name" => __("Pagination Text Hover",'theme_admin'),
						"desc" => __("<p>Set the size for the Pagination Hover Text.</p>",'theme_admin'),	
						"id" => "pagenavi_hover",
						"min" => "1",
						"max" => "60",
						"step" => "1",
					...
					array(
						"name" => __("Pagination Icon Prev Next",'theme_admin'),
						"desc" => __("<p>Set the size for the Pagination icon Prev Next.</p>",'theme_admin'),	
						"id" => "pagenavi_icon",
						"min" => "1",
						"max" => "60",
						"step" => "1",
					...
					array(
						"name" => __("Pagination Icon Prev Next Hover",'theme_admin'),
						"desc" => __("<p>Set the size for the Pagination icon Prev Next.</p>",'theme_admin'),	
						"id" => "pagenavi_icon_hover",
						"min" => "1",
						"max" => "60",
						"step" => "1",
						"unit" => 'px',
