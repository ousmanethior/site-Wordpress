		...
		$options = array(
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("WP Caption Shortcode Maximum Image Width",'theme_admin'),
						"desc" => __('<p>Set a maximum width for the wordpress caption image shortcode left/right aligned. If set to a value (greater than 0) in any caption shortcode the width paramater is reduced once it is greater than the value set here. If set to 0 this function is disabled and the theme uses the width as set in the shortcode itself. Note: This setting does not apply to the centered caption image.</p>','theme_admin'),	
						"id" => "wp_caption_width",
						"min" => "0",
						"max" => "600",
						"step" => "1",
