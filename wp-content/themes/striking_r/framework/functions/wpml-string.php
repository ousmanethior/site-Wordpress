...
wpml_register_string( THEME_NAME , 'Logo Image Source 2x', json_encode(theme_get_option('general','logo')));

wpml_register_string( THEME_NAME , 'Logo Image Source For Mobile Devices 2x', json_encode(theme_get_option('general','mobile_logo_2x')));
...
wpml_register_string( THEME_NAME,  'GDPR Consent' , stripslashes(theme_get_option('general','gdpr_consent')));
