	...
	function ddmultiselect($item){
		...
		echo '<div class="ddmultiselect-wrap">';
			echo '<div class="ddmultiselect-enabled-holder">';
				echo '<h3>'.$enable_text;
				if (!empty($enable_sub_text)) echo '<span class="ddmulti_select_subtext">'.$enable_sub_text.'</span>';
				echo '</h3>';
				echo '<ul>';
			...
			echo '<div class="ddmultiselect-disabled-holder">';
				echo '<h3>'.$disable_text;
				if (!empty($disable_sub_text)) echo '<span class="ddmulti_select_subtext">'.$disable_sub_text.'</span>';
				echo '</h3>';
				echo '<ul>';
