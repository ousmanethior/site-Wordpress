...
$custom_scheme_primary_ie8_navi_text              = $ttso->ka_custom_scheme_primary_ie8_navi_text;
...
$main_content_font_size_code = '
#main p, #main ul, #main ol { font-size:'.$main_content_font_size.';}';
...
#menu-main-nav li ul li.current-menu-ancestor ul li.current-menu-ancestor ul li.current-menu-item a {
	color: '.$design_header_menu_dropdown_currentlink.' !important;
}';
