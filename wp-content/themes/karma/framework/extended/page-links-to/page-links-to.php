...
/**
 *
 * Slightly modified by TrueThemes
 * changed location of the metabox
 * to "side" on line 257
 *
 * @since karma 4.8.6
 */
...
class CWS_PageLinksTo extends WP_Stack_Plugin {
	...
	function do_meta_boxes( $page, $context ) {
		...
		if ( in_array( $page, $plt_post_types ) && 'advanced' === $context )
			add_meta_box( 'page-links-to', _x( 'Page Links To', 'Meta box title', 'page-links-to'), array( $this, 'meta_box' ), $page, 'side', 'low' );
	}
	...
	?>
		...
		<script src="<?php echo trailingslashit( get_template_directory_uri() ) . '/framework/extended/page-links-to/js/page-links-to.js?v=4'; ?>"></script>
	<?php
	}
