...
<div id="main" class="tt-woocommerce">
		...
		//header shadow style
		if ((isset($header_shadow_style) && 'no-shadow' != $header_shadow_style) && ('Full Width' != $ka_page_title_bar_select)) : ?>
...
if( !isset($home) ) $home = _x($home_text, 'breadcrumb', 'truethemes_localize');
