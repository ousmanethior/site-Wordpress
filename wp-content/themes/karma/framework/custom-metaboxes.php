...
array(
	...
	'desc'    => __('Display a slider on this page by selecting one from the dropdown list. <a href="'.get_template_directory_uri().'/framework/admin/screenshots/screenshot-slider-types.png?TB_iframe=false" class="thickbox">View Examples</a>','truethemes_localize'),
...
array(
	...
	'desc' => __('Enter the Slider ID Number if you wish to display a 3D CU3ER slider on this page.<br /><a href="'.get_template_directory_uri().'/framework/admin/screenshots/screenshot-cu3er-slider-id.png?TB_iframe=false" class="thickbox">Where do I find the CU3ER Slider ID Number?</a>','truethemes_localize'),
...
array(
	  ...
	  'desc'    => __('<a href="'.get_template_directory_uri().'/framework/admin/screenshots/screenshot-image-frames.png?TB_iframe=false" class="thickbox">View Examples</a>','truethemes_localize'),
...
array(
	...
	'desc' => __('Upload a thumbnail image for this gallery post. This image will be automatically resized.<br /><a href="'.get_template_directory_uri().'/framework/admin/screenshots/screenshot-image-dimensions.png?TB_iframe=false" class="thickbox">View Image Dimensions</a>','truethemes_localize'),
...
array(
	...
	'desc' => __('Each gallery post can have up to 5 Lightbox items. Each item can be given a Title which is displayed within the Lightbox.<br /><br />Use the "Upload File" button to display an image or enter the full URL to display one of the other <a href="'.get_template_directory_uri().'/framework/admin/screenshots/screenshot-lightbox-media.png?TB_iframe=false" class="thickbox">Lightbox Media Types</a>.','truethemes_localize'),
	'type' => 'title'
),
