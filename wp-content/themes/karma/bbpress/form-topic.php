				...
				<legend>
					...
					<?php
						if ( bbp_is_topic_edit() )
							...
							bbp_is_single_forum() ? printf( __( '<h3><i class="fa fa-pencil-square-o" aria-hidden="true"></i> &nbsp;Create New Topic in &ldquo;%s&rdquo;</h3>', 'bbpress' ), bbp_get_forum_title() ) : _e( 'Create New Topic', 'bbpress' );
					?>
