...
function custom_nav_update($menu_id, $menu_item_db_id, $args ) {
    if (isset($_REQUEST['menu-item-mtype']) ) {
        if ( is_array($_REQUEST['menu-item-mtype']) ) {
            $custom_value = isset($_REQUEST['menu-item-mtype'][$menu_item_db_id]) ? $_REQUEST['menu-item-mtype'][$menu_item_db_id] : '';
    ...
    if (isset($_REQUEST['menu-item-mcats_layout']) ) {
        if ( is_array($_REQUEST['menu-item-mcats_layout']) ) {
            $custom_value = isset($_REQUEST['menu-item-mcats_layout'][$menu_item_db_id]) ? $_REQUEST['menu-item-mcats_layout'][$menu_item_db_id] : '';
    ...
    if (isset($_REQUEST['menu-item-mcustom']) ) {
        if ( is_array($_REQUEST['menu-item-mcustom']) ) {
            $custom_value = isset($_REQUEST['menu-item-mcustom'][$menu_item_db_id]) ? $_REQUEST['menu-item-mcustom'][$menu_item_db_id] : '';
    ...
    if (isset($_REQUEST['menu-item-micon']) ) {
        if ( is_array($_REQUEST['menu-item-micon']) ) {
            $icon_value = isset($_REQUEST['menu-item-micon'][$menu_item_db_id]) ? $_REQUEST['menu-item-micon'][$menu_item_db_id] : '';
    ...
    if (isset($_REQUEST['menu-item-mdisplay']) ) {
        if ( is_array($_REQUEST['menu-item-mdisplay']) ) {
            $icon_value = isset($_REQUEST['menu-item-mdisplay'][$menu_item_db_id]) ? $_REQUEST['menu-item-mdisplay'][$menu_item_db_id] : '';
